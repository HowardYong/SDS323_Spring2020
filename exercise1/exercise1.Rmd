...
predict(lrm, new_data)
```
According to the regression model, a 40-year-old with a rate of 135 is healthier (higher) than a 60-year-old with a rate of 112. 
...
The following is a plot of clearance rate vs. age, along with the fitted model used to reach the aforementioned conclusions.
```{r, echo=FALSE}
